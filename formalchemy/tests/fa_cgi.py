...
# NOTE: this is a patched version of cgi.py, used solely for testing
...
class MiniFieldStorage(real.MiniFieldStorage):
...
class FieldStorage(real.FieldStorage):
    ...
    def read_multi(self, environ, keep_blank_values, strict_parsing):
        ...
        if isinstance(first_line, str):
            d = lambda x: x.encode("utf-8")
            first_line = d(first_line)
        elif not isinstance(first_line, bytes):
            raise ValueError("%s should return bytes, got %s" \
